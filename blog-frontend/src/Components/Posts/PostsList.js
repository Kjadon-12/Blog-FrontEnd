            ...
            <div className="flex flex-wrap -mx-3">
              <div className="mb-8 lg:mb-0 w-full lg:w-1/4 px-3">
                <div className="py-4 px-6 bg-gray-600 shadow rounded">
                  ...
                  <ul>
                    <div>
                      {catLoading ? <LoadingComponent></LoadingComponent>: catAppErr || catServerErr ? <div className="text-red-400 text-base">{catServerErr} {catAppErr} </div>: 
                      categoryList?.length <=0 ? <div className="text-xl text-gray-100 text-center">
                            No Category Found
                     </div>  : categoryList?.map((category) => (
                                <li>
              ...
              <div className="w-full lg:w-3/4 px-3">
                 {/* post goes here */}
                 { appErr || serverErr ? <p className="text-center text-lg text-red-400">{serverErr} {appErr}</p> : postLists?.length <=0 ? <h3 className="text-white text-lg text-center">No Posts Found</h3> : 
                 postLists?.map((post)=>(
                  <div 
                  key={post.id}
