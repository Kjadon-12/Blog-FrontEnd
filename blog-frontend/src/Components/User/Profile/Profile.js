...
const  { profile , loading, appErr, serverErr , followed,  unFollowed, userAuth } = users;
 ...
 const loginUser = userAuth?._id === profile?._id
 //console.log(loginUser)
  ...
  return (
    <>
      ...
      {loading ? <LoadingComponent/> : appErr || serverErr ? <div className="text-red-500 text-lg"> {serverErr} {appErr}</div> 
      :
              ...
              <article>
                      ...
                      <div className="mt-6 sm:flex-1 sm:min-w-0 sm:flex sm:items-center sm:justify-end sm:space-x-6 sm:pb-1">
                        <div className=" flex flex-col 2xl:block mt-10 min-w-0 flex-1">
                          <h1 className="text-2xl font-bold text-gray-900 ">
                             {profile?.firstName}  {profile?.lastName} <span> {profile?.followers?.length >=1 ? <span> ✔ </span> : null}</span>
                ...
                <div className="flex justify-center place-items-start flex-wrap  md:mb-0">
                  <div className="w-full md:w-1/3 px-4 mb-4 md:mb-0">
                    ...
                    {/* Who view my post */}
                    <ul className="">
                      {profile?.viewedBy?.length <= 0 ? <h1>No One Viewed Your Profile</h1> :
                  ...
                  <div className="w-full md:w-2/3 px-4 mb-4 md:mb-0">
                    ...
                    {/* Loop here */}
                    {profile?.posts?.length <=0 ? <h4 className="text-center text-lg">No Posts</h4>:
